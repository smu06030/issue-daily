...
const CategoryNewsCard = ({ el }: { el: NewsResultsType }) => {
  return (
    <div className="font-pretendard border-2 border-solid border-black w-[23%] h-[300px]">
      <div className="h-[70%] flex justify-center">
        <Image src={el.image_url} alt={el.source_id} width={100} height={100} unoptimized className="w-auto h-full" />
      </div>
      <div className="h-[30%]">
